(function (global, factory) {
    ...
    class SplatMesh extends THREE__namespace.Mesh {
        ...
        uploadSplatDataToTextures() {
            ...
            if (this.dynamicMode) {
                const transformIndexesTextureSize = new THREE__namespace.Vector2(4096, 1024);
                ...
                const transformIndexesTexture = new THREE__namespace.DataTexture(paddedTransformIndexes, transformIndexesTextureSize.x,
                                                                      transformIndexesTextureSize.y, THREE__namespace.RedIntegerFormat,
